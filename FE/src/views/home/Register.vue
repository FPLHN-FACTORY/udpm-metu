    ...
    <a-row class="h-screen">
        <a-col :flex="1" >
            <a-flex gap="middle" align="start" vertical>
                <a-flex :style="{ ...boxStyle }" justify="center" align="center" vertical>
                    <img src="https://admin.metu.vn/assets_metu/media/logos/metu.png" alt="Metu Logo" class="mb-5" />
                    <h1 class="text-3xl font-bold text-center text-gray-600 mb-5">Chào mừng đến với METU!</h1>
                    <a-form
                        layout="horizontal"
                        class="mt-5"
                        :model="formRegister"
                    ...
                    >
                        ...
                        <a-form-item name="businessName"
                            ...
                            <a-input class="custom-input" v-model:value="formRegister.businessName" placeholder="Tên công ty/doanh nghiệp" />
                        </a-form-item>
                        <a-form-item name="businessTypeId"
                        ...
                        <a-form-item name="rePassword" 
                            ...
                            <a-input-password class="custom-input" v-model:value="formRegister.rePassword" placeholder="Xác nhận mật khẩu"/>
                        </a-form-item>
...
<script lang="ts" setup>
    ...
    import { UserService } from '@/services/service/auth/register.service'
